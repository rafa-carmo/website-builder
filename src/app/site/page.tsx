		...
		<main className="">
			<section className="h-full w-full pt-36 relative flex items-center justify-center flex-col ">
				<div
					...
					bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%_#000_70%,transparent_110%)]"
				/>
						...
						>
							...
							<CardFooter className="flex flex-col items-start gap-4">
								...
								<Link
									...
									className={clsx(
										"w-full text-center bg-primary p-2 rounded-md text-white dark:text-black",
